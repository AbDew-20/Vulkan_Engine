...
namespace ve{
	...
	void app::updateUniformBuffers(size_t currentFrame, float time) {
		...
		ubo.model= glm::rotate(glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, 1.0f)), time * glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		ubo.view = glm::lookAt(glm::vec3(0.0f, 0.0f, -2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		ubo.proj = glm::perspective(glm::radians(45.0f), veSwapChain->extentAspectRatio(), 0.1f, 25.0f);
		ubo.proj[1][1] *= -1;
