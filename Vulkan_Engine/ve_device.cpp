...
void VeDevice::createImageWithInfo(
  ...
  if (vkBindImageMemory(device_, image, imageMemory, 0) != VK_SUCCESS) {
    ...
    void VeDevice::fillBuffer(VkDeviceMemory bufferMemory, VkDeviceSize offset, VkDeviceSize size,VkMemoryMapFlags flag, const void* _src) {
        void* data;
        vkMapMemory(device_, bufferMemory, offset,size, flag, &data);
        memcpy(data, _src, (size_t)size);
